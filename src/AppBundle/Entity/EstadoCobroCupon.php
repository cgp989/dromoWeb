 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="AppBundle\Entity\EstadoCobroCuponRepository")
 * 
 */
class EstadoCobroCupon
{
    /**
     * @var integer
     *
    ...
    /**
     * @ORM\OneToMany(targetEntity="Cupon", mappedBy="estadoCobroCupon")
     */
    private $cupones;
